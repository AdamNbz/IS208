...
public class ImportGoodEmployeePanel {
    public static JPanel createMainPanel(String mand) {
        ...
        JButton addBtn = new RoundedButton("+ Thêm Phiếu Nhập");
        ...
        addBtn.addActionListener(e -> {
            ...
            JDialog dialog = new JDialog((Frame) null, "Thêm Phiếu Nhập Mới", true);
            ...
            okBtn.addActionListener(ev -> {
                try {
                    ...
                    if (success) {
                        ...
                        JOptionPane.showMessageDialog(dialog, "Thêm phiếu nhập thất bại!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(dialog, "Dữ liệu không hợp lệ hoặc lỗi khi thêm phiếu nhập!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                }
            });
    ...
    private static void showDetailDialog(String maPhieu) {
        ...
        addDetailBtn.setPreferredSize(new Dimension(200, 40));
