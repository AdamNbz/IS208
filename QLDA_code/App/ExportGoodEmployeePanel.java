...
public class ExportGoodEmployeePanel {
    public static JPanel createMainPanel() {
        ...
        JButton addBtn = new JButton("+ Thêm Phiếu Xuất");
        ...
        addBtn.addActionListener(e -> {
            ...
            int result = JOptionPane.showConfirmDialog(null, panel, "Thêm Phiếu Xuất Mới",
            ...
            if (result == JOptionPane.OK_OPTION) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Dữ liệu không hợp lệ hoặc lỗi khi thêm phiếu xuất!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
    ...
    private static void showDetailDialog(String maPhieu) {
        ...
        addDetailBtn.addActionListener(ev -> {
            ...
            int result = JOptionPane.showConfirmDialog(dialog, panel, "Thêm chi tiết phiếu xuất",
                    JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
